...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('client_notification', function(Blueprint $table) {
			$table->foreign('notificattion_id')->references('id')->on('notifications')
						->onDelete('restrict')
						->onUpdate('cascade');
		});
	}
	...
	public function down()
	{
		...
		Schema::table('client_type', function(Blueprint $table) {
			$table->dropForeign('client_type_client_id_foreign');
		});
		Schema::table('client_type', function(Blueprint $table) {
			$table->dropForeign('client_type_type_id_foreign');
		});
		Schema::table('client_notification', function(Blueprint $table) {
			$table->dropForeign('client_notification_client_id_foreign');
		});
		Schema::table('client_notification', function(Blueprint $table) {
			$table->dropForeign('client_notification_notificattion_id_foreign');
		});
	}
}